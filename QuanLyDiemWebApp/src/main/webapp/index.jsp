...
/* New User Badge Styles (Giao diện người dùng mới) */
.user-badge {
    position: absolute;
    top: 20px;
    right: 20px;
...
.btn-logout:hover {
    background: #ff4757; /* Màu đỏ khi hover */
    color: white;
...
<body>
	<div class="user-badge">
		<div class="user-info">
			Xin chào, <b><%=(currentUser != null) ? currentUser.getUsername() : "Khách"%></b>
			<span style="opacity: 0.8; font-size: 0.9em;">(<%=role.toUpperCase()%>)
			</span>
		</div>
